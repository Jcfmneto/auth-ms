...
public class UserMapper {
    ...
    public User toDomain(UserEntity user){
        return new User(user.getUsername(), user.getPassword(), user.getEmail(), user.getBornDate());
    }

    public UserEntity toEntity(User userDomain){
        return new UserEntity(userDomain.getUsername(), userDomain.getPassword(), userDomain.getEmail(), userDomain.getBornDate(), userDomain.getCreatedAt());
    }
}
